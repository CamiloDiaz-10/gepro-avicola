    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-8 sm:px-6 lg:px-8 form-container">
        <div class="glass-effect p-8 rounded-2xl w-full max-w-md animate-fade-in">
                ...
                <div>
                    ...
                    <div class="input-with-icon">
                        ...
                        <input type="password" name="Contrasena" id="Contrasena" required 
                               placeholder="••••••••">
                        <button type="button" id="togglePasswordBtn" aria-label="Mostrar u ocultar contraseña"
                                class="absolute right-2 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 focus:outline-none">
                            <!-- Ojo abierto (mostrar que se puede ver) -->
                            ...
                            <svg id="eyeOff" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.27-2.943-9.543-7a9.956 9.956 0 012.38-4.568m3.148-2.205A10.05 10.05 0 0112 5c4.478 0 8.27 2.943 9.543 7a9.964 9.964 0 01-4.293 5.364M15 12a3 3 0 00-4.243-2.829M9.88 9.172A3 3 0 0012 15c.53 0 1.03-.137 1.463-.378M3 3l18 18" />
                            </svg>
                        </button>
                    </div>
                </div>
            ...
            <script>
                ...
                // Mostrar/ocultar contraseña con el botón de ojo
                (function(){
                    const btn = document.getElementById('togglePasswordBtn');
                    const pwd = document.getElementById('Contrasena');
                    const eyeOpen = document.getElementById('eyeOpen');
                    const eyeOff = document.getElementById('eyeOff');
                    if (btn && pwd && eyeOpen && eyeOff) {
