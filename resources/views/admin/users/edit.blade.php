        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Actualiza la información del usuario {{ $user->Nombre }} {{ $user->Apellido }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="Direccion" id="Direccion" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('Direccion') border-red-500 @enderror">{{ old('Direccion', $user->Direccion) }}</textarea>
                    @error('Direccion')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
