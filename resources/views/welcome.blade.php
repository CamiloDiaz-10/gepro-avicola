...
<div class="min-h-screen bg-gradient-to-br from-green-50 to-blue-50">
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="text-center mb-16">
                ...
                <div class="space-y-4 px-4">
                    ...
                    <div class="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-md mx-auto">
                        <a href="{{ route('dashboard') }}" 
                           class="inline-flex items-center justify-center px-6 py-3 bg-green-600 border border-transparent rounded-lg font-semibold text-white text-sm sm:text-base uppercase tracking-wide hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring-2 ring-green-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                        ...
                        <x-logout-button 
                            class="inline-flex items-center justify-center px-6 py-3 bg-red-600 border border-transparent rounded-lg font-semibold text-white text-sm sm:text-base uppercase tracking-wide hover:bg-red-700 active:bg-red-900 focus:outline-none focus:border-red-900 focus:ring-2 ring-red-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md"
            ...
            @else
                <div class="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 max-w-md mx-auto px-4">
                    <a href="{{ route('login') }}" 
                       class="inline-flex items-center justify-center px-6 py-3 bg-green-600 border border-transparent rounded-lg font-semibold text-white text-sm sm:text-base uppercase tracking-wide hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring-2 ring-green-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('register') }}" 
                       class="inline-flex items-center justify-center px-6 py-3 bg-blue-600 border border-transparent rounded-lg font-semibold text-white text-sm sm:text-base uppercase tracking-wide hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring-2 ring-blue-300 disabled:opacity-25 transition ease-in-out duration-150 shadow-md">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
